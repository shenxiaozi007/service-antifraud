...
$router->post('auth/password-register', 'AuthController@passwordRegister');
$router->post('auth/password-login', 'AuthController@passwordLogin');
...
$router->get('payments/orders/{orderNo}', 'PaymentController@orderStatus');
