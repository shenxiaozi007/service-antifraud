                ...
                if (isX) {
                    ...
                    if (!shouldNotResetStyle) {
                        ...
                        if (process.env.UNI_APP_STYLE_ISOLATION_VERSION === '2' &&
                            ...
                            const basePath = path_1.default.join(process.env.UNI_INPUT_DIR, (0, uni_cli_shared_1.removeExt)(filename));
                            const styleIsolation = (0, uni_cli_shared_1.findMiniProgramComponentStyleIsolation)(basePath + '.uvue') ||
                                (0, uni_cli_shared_1.findMiniProgramComponentStyleIsolation)(basePath + '.vue');
                            if (styleIsolation &&
