...
function rewriteClass(index, classBindingProp, props, virtualHost, context) {
    ...
    if (virtualHost) {
        ...
        if (process.env.UNI_PLATFORM === 'mp-weixin' && process.env.UNI_APP_X === 'true') {
            classBindingExpr.elements.push((0, types_1.identifier)((0, utils_1.rewriteExpression)((0, compiler_core_1.createCompoundExpression)([
                `${context.helperString(runtimeHelpers_1.PARSE_VIRTUAL_HOST_CLASS)}(`,
                '_ctx.$scope.data.' + uni_shared_1.VIRTUAL_HOST_CLASS,
                `)`,
            ]), context).content));
        }
        else {
            ...
            const virtualHostClass = context.miniProgram.class.array
                ? (0, types_1.identifier)(uni_shared_1.VIRTUAL_HOST_CLASS)
                : (0, types_1.logicalExpression)('||', (0, types_1.identifier)(uni_shared_1.VIRTUAL_HOST_CLASS), (0, types_1.stringLiteral)(''));
...
function rewriteClassExpression(expr, context) {
    if ((0, utils_1.isFilterExpr)(expr, context)) {
        return (0, utils_1.rewriteExpression)(expr, context);
    }
